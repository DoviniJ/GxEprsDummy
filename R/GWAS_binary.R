...
#' @example x <- GWAS_binary(plink_path, DummyData, Bphe_discovery, Bcov_discovery, 14, 20)
#' @example head(x)
GWAS_binary <- function(plink_path, b_file, pheno_file, covar_file, n_confounders, thread, summary_output = NULL){  
  if(n_confounders > 0){
